...
const getGrade = ('../grade_maker.js');
// node tests.js to run tests
// until  need Mocha installed as dependency using npm
// see week 14 day4 to for npm dependecies and file heirachy to organise this 'project'
